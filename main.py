...
# # Feature selection
# selectionMethod = 'MRMR'
# mrmrParams = {'nFeatures': 20, 
#             'internalFEMethod': 'MID', 
#             'nBins': 4, 
#             'discStrategy': 'kmeans'}
# selectedFeatures = fesel.select_features(selectionMethod, mrmrParams, selectionFeaturesPath, manualFeaturesPath)
...
yTrueTest, yPredRegTest, yTrueVal, yPredRegVal, params = mlpred.create_evaluate_model\
    (method, rfParams, selectedFeatures, selectionFeaturesPath, manualFeaturesPath, paramSearchResultsPath, optimizeParams=False, scoringOptiMetric=scoring)
